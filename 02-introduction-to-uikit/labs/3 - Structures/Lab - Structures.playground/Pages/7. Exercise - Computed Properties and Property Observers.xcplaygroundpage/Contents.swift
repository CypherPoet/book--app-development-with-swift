...
struct Height {
    var heightInInches: Double {
        didSet {
            let properCentimeters = heightInInches * 2.54
            if heightInCentimeters != properCentimeters {
                heightInCentimeters = properCentimeters
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            let properInches = heightInCentimeters / 2.54
            if heightInInches != properInches {
                heightInInches = properInches
            }
        }
    }
...
var buildingHeight = Height(heightInCentimeters: 3030.3)

print(buildingHeight.heightInCentimeters)
print(buildingHeight.heightInInches)

buildingHeight.heightInInches = 9235
