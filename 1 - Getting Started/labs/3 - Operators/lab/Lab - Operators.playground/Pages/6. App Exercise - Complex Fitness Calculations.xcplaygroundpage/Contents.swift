 ...
 */
let heartRates = [60.23, 73.1, 60.0]

let averageHeartRate = (heartRates[0] + heartRates[1] + heartRates[2]) / 3
 ...
 */
let bodyTempFarenheit = 98.6
let bodyTempCelsius = (bodyTempFarenheit * (5.0 / 9.0)) - 32

print(bodyTempCelsius)
